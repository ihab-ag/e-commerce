<?php
    ...
    $query= $mysqli->prepare('select joined_date, count(id) as clients_count
FROM clients
...
ORDER BY joined_date DESC');
    ...
    while($a=$array->fetch_assoc()){
        $counterQ1 += $a['clients_count'];
    }
    $response['counter_clients_q1'] = $counterQ1;

    $query2= $mysqli->prepare('select joined_date, count(id) as clients_count
FROM clients
...
ORDER BY joined_date DESC');
    ...
    $counterQ2 = 0;
    while($a=$array->fetch_assoc()){
        $counterQ2 += $a['clients_count'];
    }
    $response['counter_clients_q2'] = $counterQ2;

    $query3= $mysqli->prepare('select joined_date, count(id) as clients_count
FROM clients
...
ORDER BY joined_date DESC');
    ...
    $counterQ3 = 0;
    while($a=$array->fetch_assoc()){
        $counterQ3 += $a['clients_count'];
    }
    $response['counter_clients_q3'] = $counterQ3;

    $query4= $mysqli->prepare('select joined_date, count(id) as clients_count
FROM clients
